...
void AddUserDialog::buttonCreate_clicked()
{
    ...
    // Add user
    KAuth::Action installActionAdd( QLatin1String( "org.arco.msm.users.add" ) );
    installActionAdd.setHelperId( QLatin1String( "org.arco.msm.users" ) );
    QVariantMap args;
    ...
    // Set password
    KAuth::Action installActionUsersChangePassword( QLatin1String( "org.arco.msm.users.changepassword" ) );
    installActionUsersChangePassword.setHelperId( QLatin1String( "org.arco.msm.users" ) );
    args.clear();
